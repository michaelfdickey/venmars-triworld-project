<script lang="ts">
	...
	type PayloadCategory = 'satellite' | 'infrastructure' | 'habitat' | 'vehicle' | 'supply';
	...
	const payloads: Payload[] = [
		// Satellites & Probes
		{
			...
			icon: '📡', category: 'satellite', mass: 5500, volume: '4m × 2m × 2m',
		...
		},
		{
			...
			icon: '🛰️', category: 'satellite', mass: 1200, volume: '2m × 1m × 1m',
		...
		},
		{
			...
			icon: '🔭', category: 'satellite', mass: 3200, volume: '3m × 2m × 2m',
		...
		},
		{
			...
			icon: '🎈', category: 'satellite', mass: 800, volume: '1.5m sphere',
		...
		},
		{
			...
			icon: '🌤️', category: 'satellite', mass: 2800, volume: '3m × 2m × 2m',
		...
		// Orbital Infrastructure
		{
			...
			icon: '⛽', category: 'infrastructure', mass: 12000, volume: '8m × 4.5m (cylinder)',
		...
		},
		{
			...
			icon: '☀️', category: 'infrastructure', mass: 8000, volume: '4m packed → 50m span',
		...
		},
		{
			...
			icon: '🏗️', category: 'infrastructure', mass: 25000, volume: '20m × 8m × 8m',
		...
		},
		{
			...
			icon: '⚡', category: 'infrastructure', mass: 18000, volume: '15m × 3m × 3m',
		...
		},
		{
			...
			icon: '🛡️', category: 'infrastructure', mass: 6000, volume: '5m × 5m panels',
		...
		// Habitat Modules
		{
			...
			icon: '🏠', category: 'habitat', mass: 20000, volume: '10m × 4.5m (pressurized)',
		...
		},
		{
			...
			icon: '🌑', category: 'habitat', mass: 15000, volume: '8m × 5m (deployable)',
		...
		},
		{
			...
			icon: '🎈', category: 'habitat', mass: 9000, volume: '12m envelope + 4m gondola',
		...
		},
		{
			...
			icon: '🔴', category: 'habitat', mass: 22000, volume: '10m × 6m (pressurized)',
		...
		},
		{
			...
			icon: '🚀', category: 'habitat', mass: 35000, volume: '12m × 5m (with centrifuge)',
		...
		// Vehicles & Landers
		{
			...
			icon: '🛡️', category: 'vehicle', mass: 9000, volume: '5m × 3.5m (capsule)',
		...
		},
		{
			...
			icon: '🔧', category: 'vehicle', mass: 3500, volume: '4m × 2m',
		...
		},
		{
			...
			icon: '🎈', category: 'vehicle', mass: 400, volume: '3m wingspan',
		...
		// Supply & Logistics
		{
			...
			icon: '🍱', category: 'supply', mass: 6000, volume: '3m × 2.5m',
		...
		},
		{
			...
			icon: '⚙️', category: 'supply', mass: 8500, volume: '4m × 3m × 2m',
		...
		},
		{
			...
			icon: '🧱', category: 'supply', mass: 20000, volume: 'Standard pallet (4m × 4m × 3m)',
			...
			<div class="payload-card">
				...
				<div class="payload-stats">
					...
					<div class="stat">
						...
						<span class="stat-value">{payload.volume}</span>
					</div>
					<div class="stat">
